...
#ifndef CUBE_IMU_CALIBRATION__MSG__DETAIL__RECORDER_STATUS__TYPE_SUPPORT_H_
#define CUBE_IMU_CALIBRATION__MSG__DETAIL__RECORDER_STATUS__TYPE_SUPPORT_H_
...
#endif  // CUBE_IMU_CALIBRATION__MSG__DETAIL__RECORDER_STATUS__TYPE_SUPPORT_H_
