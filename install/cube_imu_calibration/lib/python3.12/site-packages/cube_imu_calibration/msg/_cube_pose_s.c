...
bool cube_imu_calibration__msg__cube_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cube_imu_calibration.msg._cube_pose.CubePose", full_classname_dest, 44) == 0);
  }
  cube_imu_calibration__msg__CubePose * ros_message = _ros_message;
  {  // header
  ...
  {  // transform
    ...
    }
    {
      ...
      Py_ssize_t size = 16;
      double * dest = ros_message->transform;
...
{
  /* NOTE(esteve): Call constructor of CubePose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cube_imu_calibration.msg._cube_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CubePose");
  ...
  {  // transform
    ...
    double * src = &(ros_message->transform[0]);
